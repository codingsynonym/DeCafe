...
use SpeechToTextAnalyzerContexta360Lib\Exceptions\ApiException;
use SpeechToTextAnalyzerContexta360Lib\Http\HttpRequest;
use SpeechToTextAnalyzerContexta360Lib\Http\HttpResponse;
use stdClass;
...
class ApiHelper
{
    ...
    public static function mapClass(
        ...
        string $classname,
        int $dimension = 0,
        string $namespace = 'SpeechToTextAnalyzerContexta360Lib\Models'
    ) {
        try {
